...
export class CommentsApi extends runtime.BaseAPI {
     ...
     * Retrieve comments
     */
    async v1CommentsGetRaw(requestParameters: V1CommentsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
     ...
     * Retrieve comments
     */
    async v1CommentsGet(requestParameters: V1CommentsGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
     ...
     */
    async v1CommentsPostRaw(requestParameters: V1CommentsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        const queryParameters: any = {};
     ...
     * Add comment to discussion
     */
    async v1CommentsPost(requestParameters: V1CommentsPostRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
