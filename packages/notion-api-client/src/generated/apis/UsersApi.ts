...
export interface V1UsersMeGetRequest {
    notionVersion?: string;
}
...
export class UsersApi extends runtime.BaseAPI {
     ...
     * List all users
     */
    async v1UsersGetRaw(requestParameters: V1UsersGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
     ...
     * List all users
     */
    async v1UsersGet(requestParameters: V1UsersGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
     ...
     * Retrieve a user
     */
    async v1UsersIdGetRaw(requestParameters: V1UsersIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
     ...
     * Retrieve a user
     */
    async v1UsersIdGet(requestParameters: V1UsersIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
     ...
     */
    async v1UsersMeGetRaw(requestParameters: V1UsersMeGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        const queryParameters: any = {};
     ...
     * Retrieve your token’s bot user
     */
    async v1UsersMeGet(requestParameters: V1UsersMeGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.v1UsersMeGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
